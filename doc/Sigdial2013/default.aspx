...
.compositeModule_3Zone.homepage.grayBG
{
    background:#eee;
    margin:30px 0px;
    padding-top:10px;
...
.w14 {width:74.9%;}
.w15, .compositeModule_1Zone > div.zone, #chNav #chP table, #contentArea #dedlM table.inner {width:100%;}
...
.w29 {width:297px;}
#contentArea #dedlM table.outer td.left {width:315px;}
...
.c2, #contentArea .rssM .publisher {color:#7fba00;}
...
.pt8, #contentArea #dedlM table.inner td {padding-top:9px;}
...
#contentArea .conM table.borderColumns td, table.borderColumns th { border-left: solid 1px; border-right: solid 1px;}
    ...
    b: {
        ...
        V9: (navigator.appVersion.indexOf("MSIE 9") > -1 || navigator.appVersion.indexOf("MSIE 10") > -1),
    ...
    Translator: {
        ...
        FillLanguages: function () {
            ...
            var langNames = Microsoft.Translator.getLanguageNames();
            for (var i in langIds) {
                ...
                else if (langNames[i] > "Original" && langNames[i-1]< "Original") {
                    o.value = "en";
                    o.text = "Original";
                    s.appendChild(o);
                    o = document.createElement("option");
            ...
            //s.options[0].style.color = "lightgrey";
        },
        Translate: function () {
            var s = document.getElementById("selLang");
            ...
            var i = new Image();
            i.src = "http://research.microsoft.com/a/bi.txt?" + p + rmc.Translator.CurrentLanguage;
            return;
  ...
  <meta name="description" content="The &quot;spoken dialog challenge 2010 corpus&quot; is an existing open-source corpus of interactions between people and various spoken dialog systems, published by Carnegie Mellon University. The data I would like to release consists of transcriptions of what people said, and annotations of various phenomena in the data, such as whether the speech recognizer correctly recognized the meaning of the speaker. This covers about 1500 conversations. The data I would like to release contains some of the data from the original corpus, reformatted to make it easier to use to perform experimental work. The movitation for releasing this data is to support the &quot;dialog state tracking challenge&quot; which I am organizing. This challenge task seeks to marshall the community toward this research problem, which is of interest to Microsoft.">
...
<body style="">
    ...
    <div class="center sw pr">
        <div class="pl16">
            <a href="/c/1400" onClick="stc(this, 1)">
        ...
        <div id="chP" class="pl16 mt19 fs28">
            <div id="ctl00_Navigation2_holder"><div><a href="/c/1410" class="sel" onClick="stc(this, 2)">Our research</a></div>
<div><a href="/c/1420" onClick="stc(this, 3)">Connections</a></div>
<div><a href="/c/1430" onClick="stc(this, 4)">Careers</a></div>
<div><a href="/c/1440" onClick="stc(this, 5)">About us</a></div></div>

        </div>
        <div style="position: absolute; right: 40px; top: 0px;">
            <div class="tar fs30"><a class="tdn c3 translator" href="/c/1401" onClick="stc(this, 6)">Microsoft Translator</a> <span class="c18 pl3">|</span> <select class="bd1 fs30" translate="no" id="selLang" onchange="rmc.Translator.Translate();"></select></div>
        ...
        <div id="chS" class="pl16 fs29">
            <div id="ctl00_Navigation4_holder"><div><a href="/c/1411" onClick="stc(this, 7)">All</a></div>
<div><a href="/c/1412" class="sel" onClick="stc(this, 8)">Downloads</a></div>
<div><a href="/c/1413" onClick="stc(this, 9)">Events</a></div>
<div><a href="/c/1414" onClick="stc(this, 10)">Groups</a></div>
<div><a href="/c/1415" onClick="stc(this, 11)">News</a></div>
<div><a href="/c/1416" onClick="stc(this, 12)">People</a></div>
<div><a href="/c/1417" onClick="stc(this, 13)">Projects</a></div>
<div><a href="/c/1418" onClick="stc(this, 14)">Publications</a></div>
<div><a href="/c/1419" onClick="stc(this, 15)">Videos</a></div></div>
    ...
    <div id="mainZone" class="zone">
      <div class="title deM">
      Dialog State Tracking Challenge data (train3 dataset)<div class="cl">
      ...
      <div class="compositeModule_2_1Zone ">
          ...
          <div id="" class="zone">
            <div class="deM" id="dedlM">
  <p>This download contains a portion of the data for the "Dialog State Tracking Challenge" (DSTC).  Specifically, it contains data and labels for the "train3" set.  The source data is based on the "Spoken Dialog Challenge" corpus, published by Carnegie Mellon University, with labels and some transcriptions added by Microsoft.  For more information about the DSTC, including pointers to the other datasets, see http://research.microsoft.com/en-us/events/dstc/</p>
      ...
      <td class="left">
        ...
        <table class="inner" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="right">dstc_data_train3_v00.tgz</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="left">Date Published</td>
            <td class="right">13 February 2013</td>
          </tr>
          <tr>
            <td class="left">Download Size</td>
            <td class="right">12.43 MB</td>
          </tr>
        </table>
      </td>
      <td class="right">
        <form method="get" action="http://ftp.research.microsoft.com/downloads/7f73c09d-7638-4f41-bfc4-a211a7fd4859/dstc_data_train3_v00.tgz">
          <button type="submit">Download </button>
        </form>
        <p>
          <b>Note </b>By installing, copying, or otherwise using this software, you agree to be bound by the terms of its license. <a href="MSR-LA - Spoken Data Corpus.txt" onClick="stc(this, 16)">Read the license</a>.</p>
      </td>
    </tr>
  </table>
  <div class="btm"></div>
  <script type="text/javascript">rmc.BreadCrumb([{t:'Downloads',u:'/apps/dp/dl/downloads.aspx'},{t:'Dialog State Tracking Challenge data (train3 dataset)',u:null}]);</script>
</div><div class="cl">

</div>
            <div class="conM ">This dataset contains content generated from user recordings and may contain terms that some may consider offensive, indecent or otherwise objectionable. Microsoft is not responsible or liable for any content in the dataset that may be deemed to be offensive, indecent, or otherwise objectionable.</div>
        <div style="clear:both;"></div>
          </div>
          <div id="" class="zone"></div>
    ...
    <div class="center sw mt21">
        <div class="pl16" style="height:24px;">
            <div class="dib mr19 f3 fs18 c11">Share</div>
            <div class="dib vam" style="height:24px;"><a href="javascript:rmc.Share('F');void(0);"><img class="mr20" title="Share this page on Facebook" alt="Share this page on Facebook " src="/a/i/c/facebook.png" border="0" width="24" height="24" /></a></div>
            <div class="dib vam" style="height:24px;"><a href="javascript:rmc.Share('T');void(0);"><img class="mr20" title="Share this page on Twitter" alt="Share this page on Twitter" src="/a/i/c/twitter.png" border="0" width="24" height="24" /></a></div>
            <div class="dib vam" style="height:24px;"><a href="javascript:rmc.Share('L');void(0);"><img class="mr20" title="Share this page on LinkedIn" alt="Share this page on LinkedIn" src="/a/i/c/linkedin.png" border="0" width="24" height="24" /></a></div>
            <div class="dib vam" style="height:24px;"><a href="javascript:rmc.Share('M');void(0);"><img class="mr20" title="E-mail this page" alt="E-mail this page" src="/a/i/c/email.png" border="0" width="24" height="24" /></a></div>
            <div class="dib vam" style="height:24px;"><a href="/c/1464" onClick="stc(this, 17)"><img class="mr20" title="RSS feeds" alt="RSS feeds" src="/a/i/c/rss.png" border="0" width="24" height="24" /></a></div>
        </div>
        <div style="height: 1px; background: #ccc;margin-top:20px;margin-bottom:7px;"></div>
    


        <div id="ctl00_ctl00_holder" class="shellFooter"><div id="footer" class="center sw pr mb12 pl7"><div class="pa" style="right:165px;">&copy;2013 Microsoft</div><div class="pa" style="right:40px;margin-top:-1px;"><a href="/c/1456" onClick="stc(this, 18)"><img style="display:block;" alt="Microsoft" align="" title="Microsoft" src="/a/i/c/ms-logo.png" border="0" width="88" height="19"></a></div><div class="din pl19"><a href="/c/1450" onClick="stc(this, 19)">Contact us</a></div><div class="din pl19"><a href="/c/1451" onClick="stc(this, 20)">Privacy &amp; cookies</a></div><div class="din pl19"><a href="/c/1452" onClick="stc(this, 21)">Terms of use</a></div><div class="din pl19"><a href="/c/1453" onClick="stc(this, 22)">Trademarks</a></div><div class="din pl19"><a href="/c/1454" onClick="stc(this, 23)">Code of conduct</a></div><div class="din pl19"><a href="javascript:OpenFeedback();">Feedback</a></div><div class="din pl19"><a href="/c/1502" onClick="stc(this, 24)">Mobile</a></div></div></div>
