...
A recent work by Morbini et al. \shortcite{Morbini:2012} is similar to us. They rescored the N-Best with the objective to increase the performance of NLU component by combining different ASR engines. It proposed a classification model to evaluate different ASR engines, but not the semantic meaning of the sentences.
...
This data is collected by Amazon Mechanical Turk. %what does the task look like?
